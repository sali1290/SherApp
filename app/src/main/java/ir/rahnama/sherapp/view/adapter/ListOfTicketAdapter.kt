...
class ListOfTicketAdapter(
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (ticketList[position].ticket_state==1){
            ...
            holder.ticket_state.setTextColor(context.resources.getColor(R.color.red))
            holder.ticket_state_layout.background=context.resources.getDrawable(R.color.red)
        }
